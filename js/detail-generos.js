window.addEventListener("load", function () {
    ...
    if(type=="movies"){
        ...
        .then(function (data) {
            ...
            for (let i = 0; i < data.results.length ; i++) {
                listaGenero.innerHTML += `<h3> ${data.results[i].name} </h3>
                <li><a href="detail-serie.html?id=${data.results[i].id}"> <img src="https://image.tmdb.org/t/p/w500/${data.results[i].poster_path}">
